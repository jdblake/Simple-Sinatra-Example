...
You can access the database through the ruby interactive shell (<b>irb</b> or even better:
<b>dm-cli</b>) and change the db that way.

(You have a lot more control over the db this way)
